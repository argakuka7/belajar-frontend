...
- Link bab berikutnya menunjuk `/06-javascript-variabel-tipe-kontrol-aliran/`. Bab 6 belum dibuat, jadi slug ini perkiraan terbaik, mengikuti pola penamaan bab ber-cover model.
