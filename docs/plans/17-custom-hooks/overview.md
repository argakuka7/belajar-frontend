...
- Demo Hidup memuat React lewat CDN ESM dari esm.sh, versi dipatok `react@19.2.8` dan `react-dom@19.2.8`, tanpa import map, tanpa build tool, mengikuti pola bab 14. Demo memakai `React.createElement` karena JSX butuh proses build; sejak bab 15 pembaca sudah kenal JSX, jadi cukup satu kalimat pengantar.
