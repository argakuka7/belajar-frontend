...
- Jargon yang didefinisikan pertama kali: performa, bundle, bundler, build tool, request atau permintaan, lazy load, eager, code splitting, dynamic import, React.lazy, Suspense, format gambar, WebP dan AVIF, srcset, data URI, IntersectionObserver, layout shift atau pergeseran tata letak.
