...
- Demo Hidup memuat React lewat CDN ESM dari esm.sh, versi dipatok `react@18.3.1` dan `react-dom@18.3.1`, tanpa import map dan tanpa build tool, sesuai ADR-0003 dan ketentuan bab React. Demo memakai `React.createElement` karena JSX tidak bisa jalan tanpa build, dan JSX memang wilayah bab 15. Ini sekaligus jujur secara pedagogis: pembaca melihat bentuk mentah yang nanti disingkat JSX.
